...
int main(){
	...
	//	   		Your total payable interest is $3000.000000  when principal_amount given as 1000.0, duration is 5
      ...
      total_interest = duration * rate * principal_amount;
      printf("Your total payable interest is %lf when principle_amount given as %lf, duration is %d",total_interest, principal_amount, duration);
